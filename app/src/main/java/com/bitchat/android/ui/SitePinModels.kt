...
enum class SitePinType(
    ...
    SNAG("Snag", Color(0xFFE8960C), Icons.Filled.Build, "SNAG", 1),
    NOTE("Note", Color(0xFF3B82F6), Icons.AutoMirrored.Filled.StickyNote2, "NOTE", 2),
    SAFE_ZONE("Safe Zone", Color(0xFF34C759), Icons.Filled.Shield, "SAFE_ZONE", 3);
